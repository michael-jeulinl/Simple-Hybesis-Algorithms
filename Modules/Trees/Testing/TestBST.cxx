...
TEST(TestBST, construction)
{
  ...
  // Basic construction
  {
    ...
    const Value_type kLeftChildData = tree->GetLeftChild()->GetData();
    const Value_type kRightChildData = tree->GetRightChild()->GetData();

    EXPECT_EQ(2, tree->GetData());
    EXPECT_EQ(1, kLeftChildData);
    EXPECT_EQ(3, kRightChildData);
  }
}
