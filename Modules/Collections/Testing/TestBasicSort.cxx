...
TEST(TestBasicSort, PartitionBasics)
{
  ...
  // Normal Run - Random Array
  {
    ...
    SHA_Collections::Partition<Iterator_type, Comparator_type>(randomdArray.begin(), pivot, randomdArray.end());
  ...
  // Already sortedArray - Array should not be affected
  {
    ...
    SHA_Collections::Partition<Iterator_type, Comparator_type>(sortedArray.begin(), pivot, sortedArray.end());
  ...
  // Begin and End inversed - Array should not be affected
  {
    ...
    SHA_Collections::Partition<Iterator_type, Comparator_type>(randomdArray.end(), pivot, randomdArray.begin());
  ...
  //String collection - Should result in: max[begin, pivot[ <= pivot <= min]pivot, end]
  {
    ...
    // Run partition
    SHA_Collections::Partition<std::string::iterator, Comparator_type>(randomStr.begin(), pivot, randomStr.end());
...
TEST(TestBasicSort, PartitionGreaterComparator)
{
  ...
  // Already InverseSortedArray - Array should not be affected
  {
    ...
    SHA_Collections::Partition<Iterator_type, Comparator_type>(invSortedArray.begin(), pivot, invSortedArray.end());
...
TEST(TestBasicSort, QuickSortBasics)
{
  ...
  // Unique value array - Array should not be affected
  {
    ...
    SHA_Collections::QuickSort<Iterator_type, Comparator_type>(uniqueValueArray.begin(), uniqueValueArray.end());
  ...
  // String - String should be sorted as an array
  {
    ...
    SHA_Collections::QuickSort<std::string::iterator, Comparator_type>(stringToSort.begin(), stringToSort.end());
...
TEST(TestBasicSort, QuickSortGreaterComparator)
{
  ...
  // Already sorted Array in inverse order - Array should not be affected
  {
    ...
    SHA_Collections::QuickSort<Iterator_type, Comparator_type>(invSortedArray.begin(), invSortedArray.end());
...
TEST(TestBasicSort, MergeInPlaceBasics)
{
  ...
  // Normal Run - All elements should be sorted in order
  {
    ...
    SHA_Collections::MergeInPlace<Iterator_type>()(sortedArrayWithRot.begin(), sortedArrayWithRot.begin() + 4, sortedArrayWithRot.end());
  ...
  {
    std::vector<int> sortedArrayPos(SortedArrayIntPos, SortedArrayIntPos + sizeof(SortedArrayIntPos) / sizeof(int));
    SHA_Collections::MergeInPlace<Iterator_type>()(sortedArrayPos.begin(), sortedArrayPos.begin() + 5, sortedArrayPos.end());
  ...
  {
    std::vector<int> randomArrayPos(RandomArrayIntPos, RandomArrayIntPos + sizeof(RandomArrayIntPos) / sizeof(int));
    SHA_Collections::MergeInPlace<Iterator_type>()(randomArrayPos.end(), randomArrayPos.begin() + 3, randomArrayPos.begin());
  ...
  {
    std::vector<int> uniqueValueArray(1, 511);
    SHA_Collections::MergeInPlace<Iterator_type>()(uniqueValueArray.begin(), uniqueValueArray.end(), uniqueValueArray.end());
    EXPECT_EQ(511, uniqueValueArray[0]);
  }
  ...
  // Double values array - Order should be made
  {
    ...
    SHA_Collections::MergeInPlace<Iterator_type>()(doubleValuesArray.begin(), doubleValuesArray.begin() + 1, doubleValuesArray.end());
  ...
  // String Collection - All elements should be sorted in order
  {
    ...
    SHA_Collections::MergeInPlace<std::string::iterator>()(stringToMerge.begin(), stringToMerge.begin() + 4, stringToMerge.end());
...
TEST(TestBasicSort, MergeWithBufferBasics)
{
  ...
  {
    std::vector<int> sortedArrayWithRot(SortedArrayIntWithRot, SortedArrayIntWithRot + sizeof(SortedArrayIntWithRot) / sizeof(int));
    SHA_Collections::MergeWithBuffer<Container_type, Iterator_type>()(sortedArrayWithRot.begin(), sortedArrayWithRot.begin() + 4, sortedArrayWithRot.end());
  ...
  {
    std::vector<int> sortedArrayPos(SortedArrayIntPos, SortedArrayIntPos + sizeof(SortedArrayIntPos) / sizeof(int));
    SHA_Collections::MergeWithBuffer<Container_type, Iterator_type>()(sortedArrayPos.begin(), sortedArrayPos.begin() + 5, sortedArrayPos.end());
  ...
  {
    std::vector<int> randomArrayPos(RandomArrayIntPos, RandomArrayIntPos + sizeof(RandomArrayIntPos) / sizeof(int));
    SHA_Collections::MergeWithBuffer<Container_type, Iterator_type>()(randomArrayPos.end(), randomArrayPos.begin() + 3, randomArrayPos.begin());
  ...
  {
    std::vector<int> emptyArray;
    SHA_Collections::MergeWithBuffer<Container_type, Iterator_type>()(emptyArray.begin(), emptyArray.begin(), emptyArray.end());
  }

  // Unique value array - Array should not be affected
  {
    std::vector<int> uniqueValueArray(1, 511);
    SHA_Collections::MergeWithBuffer<Container_type, Iterator_type>()(uniqueValueArray.begin(), uniqueValueArray.end(), uniqueValueArray.end());
    EXPECT_EQ(511, uniqueValueArray[0]);
  }
  ...
  // Double values array - Order should be made
  {
    ...
    SHA_Collections::MergeWithBuffer<Container_type, Iterator_type>()(doubleValuesArray.begin(), doubleValuesArray.begin() + 1, doubleValuesArray.end());
  ...
  // String Collection - All elements should be sorted in order
  {
    ...
    SHA_Collections::MergeWithBuffer<std::string, std::string::iterator>()(stringToMerge.begin(), stringToMerge.begin() + 4, stringToMerge.end());
...
TEST(TestBasicSort, MergeSortBasics)
{
  ...
  {
    std::vector<int> randomdArray(RandomArrayInt, RandomArrayInt + sizeof(RandomArrayInt) / sizeof(int));
    SHA_Collections::MergeSort<Container_type, Iterator_type, Aggregator_type>(randomdArray.begin(), randomdArray.end());
  ...
  {
    std::vector<int> sortedArray(SortedArrayInt, SortedArrayInt + sizeof(SortedArrayInt) / sizeof(int));
    SHA_Collections::MergeSort<Container_type, Iterator_type, Aggregator_type>(sortedArray.begin(), sortedArray.end());
  ...
  {
    std::vector<int> randomdArray(RandomArrayInt, RandomArrayInt + sizeof(RandomArrayInt) / sizeof(int));
    SHA_Collections::MergeSort<Container_type, Iterator_type, Aggregator_type>(randomdArray.end(), randomdArray.begin());
  ...
  {
    std::vector<int> emptyArray;
    SHA_Collections::MergeSort<Container_type, Iterator_type, Aggregator_type>(emptyArray.begin(), emptyArray.end());
  }

  // Unique value array - Array should not be affected
  {
    std::vector<int> uniqueValueArray(1, 511);
    SHA_Collections::MergeSort<Container_type, Iterator_type, Aggregator_type>(uniqueValueArray.begin(), uniqueValueArray.end());
    EXPECT_EQ(511, uniqueValueArray[0]);
  }
  ...
  {
    std::string randomStr = RandomStr;
    SHA_Collections::MergeSort<std::string, std::string::iterator, AggregatorStr_type>(randomStr.begin(), randomStr.end());
